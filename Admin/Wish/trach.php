...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	?>
		<div class="navlist">
			<a href="/Admin/Wish/index.php">许愿列表</a>
			<a href="/Admin/Wish/trach.php" class="cur">回收站</a>
		</div>
		<table class="table">
			<tr>
				<td width="3%">ID</td>
...
<!--						<a href="/Admin/Wish/--><?php //if ($wishes[$i]['statu'] == 0): ?><!--yes--><?php //else: ?><!--no--><?php //endif; ?><!--?id=--><?php //echo $wishes[$i]['id'] ?><!--">--><?php //if ($wishes[$i]['statu'] == 0): ?><!--通过--><?php //else:?><!--不准通过--><?php //endif; ?><!--</a>-->
						<a href="javascript:if(confirm('确实要恢复吗?'))location='/Admin/Wish/delete.php?id=<?php echo $wishes[$i]['id'] ?>&type=trach&page=<?php echo $page; ?>'">恢复</a>
					</td>
				</tr>
			<?php endfor;?>
			<tr>
				<td colspan="7"><div class="pagesize"><?php echo $pageHtml; ?></div></td>
			</tr>
		</table>
	</body>
</html>
